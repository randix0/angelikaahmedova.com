...
As a new WordPress user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
	...
	// MyWordPress custom plugins activation
	$plugins_to_activate = array('rh/rh.php', 'russian-date.php', 'cyr2lat/cyr-to-lat.php');

	foreach ($plugins_to_activate as $plugin_path) {
