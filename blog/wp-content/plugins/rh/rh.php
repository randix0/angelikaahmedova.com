...
function rushelper_admin_head()
{
  ...
  foreach ($scripts as $script)
    printf("<script type='text/javascript' src='%s%s'></script>", $baseurl, $script);
  printf("<link rel='stylesheet' href='%s%s' type='text/css' media='all' />", $baseurl, 'wp-content/plugins/rh/css/colorbox.css');
}
